...
function CounsellorDashboard() {
	...
	const [showCallConnectingModal, setShowCallConnectingModal] = useState(false);
	...
	const declineIcommingCall = () => {
		send(conn, getSocketJson("decline", "decline", token, role, patientRole));
		setShowCallConnectingModal(false);
	};
	...
	const toggleMute = () => {
		...
		//         });
		//     });
		console.log("this is the getSenders", patientPeerConnection.getSenders());
		if (

...
import {
  ...
  StyledSongName
} from "./DynamicIsland.styles.js"; // Ensure correct path to styles
  ...
  return (
    ...
    >
      <StyledDynamicIslandTopContent isOpen={isOpen}>
        ...
        <div>
          {isOpen && (
            <StyledArtistDetailsMotion
              ...
              animate={{ opacity: 1 }}
            >
              <StyledMusicIconMotion animate={{ opacity: isOpen ? [0, 1] : 1 }} style={{ marginLeft: "150px"}}> 
              ...
              <StyledMusicIconMotion animate={{ opacity: isOpen ? [0, 1] : 1 }} 
                  style={{position: "absolute", marginTop: "-43px", marginLeft: "160px"}}> 
                <StyledMusicIconBarMotion
                  initial={{ height: "0" }}
                  animate={{ height: "100%" }}
                  transition={{ duration: 1, delay: 0.5, repeat: Infinity }}
              ...
              <StyledMusicIconMotion animate={{ opacity: isOpen ? [0, 1] : 1 }} 
                  style={{position: "absolute", marginTop: "-43px", marginLeft: "140px"}}> 
                <StyledMusicIconBarMotion
                  initial={{ height: "0" }}
                  animate={{ height: "100%" }}
                  transition={{ duration: 1, delay: 0.5, repeat: Infinity }}
              ...
              <StyledSongName style={{marginTop: "-16px"}}>Jethalal</StyledSongName>
        ...
        <StyledMusicIconMotion animate={{ opacity: isOpen ? [0, 1] : 1 }} style={{position: "absolute", marginLeft: "190px"}}>
          <StyledMusicIconBarMotion
            initial={{ height: "0" }}
            animate={{ height: "100%" }}
            transition={{ duration: 1, delay: 0.3, repeat: Infinity }}
      ...
      {isOpen && (
        <>
          <StyledPlayBarWrapper>
          <h4 style={{marginLeft: "79px", color: "beige"}}>{time}</h4>
          </StyledPlayBarWrapper>
          <StyledSongControlsWrappers>
            <div />
            <StyledSongControls>
